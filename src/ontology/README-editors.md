These notes are for the EDITORS of caro
...
Make sure you have an ID range in the [idranges file](caro-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [caro-edit.owl](caro-edit.owl)

** DO NOT EDIT caro.obo OR caro.owl in the top level directory **

[../../caro.owl](../../caro.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/obophenotype/caro) for details.
 ...
 * [caro-idranges.owl](caro-idranges.owl)
...
This generates derived files such as caro.owl and caro.obo and places
 ...
 * https://github.com/obophenotype/caro/releases
 * https://github.com/obophenotype/caro/releases/new
...
what is in the `owl:versionIRI` of the derived caro.owl (`data-version` in
caro.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/caro.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/caro/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/obophenotype/caro.svg?branch=master)](https://travis-ci.org/obophenotype/caro)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/obophenotype](https://travis-ci.org/profile/obophenotype)
 2. click the "Sync account" button
 3. Click the tick symbol next to caro
